...
public class NumberUtils {
    ...
    public static String keepPrecision(String number, int precision) {
        ...
        return bg.setScale(precision, BigDecimal.ROUND_HALF_EVEN).toPlainString();
    }
...
//        BigDecimal bg = new BigDecimal(number);
//        return Double.valueOf(bg.setScale(precision, BigDecimal.ROUND_HALF_UP).toPlainString());
//    }
