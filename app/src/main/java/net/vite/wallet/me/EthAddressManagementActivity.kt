...
class EthAddressManagementActivity : UnchangableAccountAwareActivity() {


    lateinit var adapter: EthAddressListAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        inforBubbleTxt.visibility = View.GONE
        inforImg.visibility = View.GONE
        textViewtitle.text = getString(R.string.eth_address_manage)
                    ...
                    setFirstButton(getString(R.string.confirm)) {
                        ...
                        if (newName.isBlank()) {
                            ...
                            if (VCFsmHolder.hasExistSession()) {
                                with(TextTitleNotifyDialog(this@EthAddressManagementActivity)) {
                                    ...
                                    setBottom(R.string.confirm) { warmNoticeDialog ->
                                        ...
                                        if (currentAccount.changeAddressName(
                                            ...
                                            this@EthAddressManagementActivity.addressName.text =
                                                newName
                                ...
                                if (currentAccount.changeAddressName(address, newName) == true) {
                                    addressItemTextView.text = newName
                                    this@EthAddressManagementActivity.addressName.text = newName
                                    showToast(R.string.change_success)
                                }
                            }
                        }
        ...
        defaultReceiverAddress.text = currentAccount.nowEthAddress() ?: ""
        addressName.text = currentAccount.getAddressName(currentAccount.nowEthAddress() ?: "")

        adapter = EthAddressListAdapter(
            currentAccount.allEthIndex.toMutableList(),
            addressName,
        ...
        if (currentAccount.nowEthMaxIndex == 99) {
    ...
    fun showDialog() {
        ...
        builder.setPositiveButton(getString(R.string.confirm)) { dialog, which ->
            ...
            val curIndex = currentAccount.allEthIndex.size
    ...
    fun recoveryAddresses(index: Int) {
        val curIndex = currentAccount.allEthIndex.size - 1
...
//                Toast.makeText(this, R.string.address_size_exceed, Toast.LENGTH_SHORT).show()
            ...
            currentAccount.deriveNewEthAddress()?.let {
