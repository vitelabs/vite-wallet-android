...
public class TypeDecoder {
    ...
    static <T extends Type> T decode(String input, int offset, Class<T> type) {
        ...
        } else if (Gid.class.isAssignableFrom(type)) {
            return (T) decodeGid(input.substring(offset));
        } else if (TokenId.class.isAssignableFrom(type)) {
            return (T) decodeTokenId(input.substring(offset));
    ...
    static Address decodeAddress(String input) {
        try {
            ...
            throw new UnsupportedOperationException(
                    "Unable to create instance of  address", e);
        }
    }

    static Gid decodeGid(String input) {
        try {
            return new Gid(input);
        } catch (Exception e) {
            throw new UnsupportedOperationException(
                    "Unable to create instance of  gid", e);
        }
    }

    static TokenId decodeTokenId(String input) {
        try {
            return new TokenId(input);
        } catch (Exception e) {
            throw new UnsupportedOperationException(
                    "Unable to create instance of  tokenId", e);
        }
    }
        ...
        try {
            Class<? extends StaticArray> arrayClass =
                    (Class<? extends StaticArray>) Class.forName(
                            "net.vite.wallet.abi.datatypes.generated.StaticArray" + length);
